...
#################################################
#1
#Start st the homepage
#List all available routes

@app.route('/')
def home():
    """Welcome to the homepage. Here are all the available routes."""
    return(
        f"Homepage<br/>"
...
#2
#Convert query results from analysis (last 12 months) to a dictionary using date as the key and pecp as value
...
#4
#Query the date and temps of the most active station for the prev year
#Return a JSON list of temps for the prev year
...
#For specified start and end date calculate TMIN, TAVG and TMAX for the dates from the start to end date inclusive
